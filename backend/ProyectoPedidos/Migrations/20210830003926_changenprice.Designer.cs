...
namespace ProyectoPedidos.Migrations
{
    ...
    [Migration("20210830003926_changenprice")]
    partial class changenprice
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ProyectoPedidos.Models.PedidoAprobacionControl", b =>
                {
                    b.Property<int>("PedidoAprobacionControlId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);

                    b.Property<DateTime>("AprobacionFecha")
                    ...
                    b.Property<int?>("PedidoOrdenPedidoId")
                        .HasColumnType("int");

                    b.Property<int>("SupervisorId")
                        .HasColumnType("int");

                    b.HasKey("PedidoAprobacionControlId");

                    b.HasIndex("PedidoOrdenPedidoId");

                    b.HasIndex("SupervisorId");

                    b.ToTable("PedidoArprobacionControl");
                });
            ...
            modelBuilder.Entity("ProyectoPedidos.Models.PedidoAprobacionControl", b =>
                {
                    b.HasOne("ProyectoPedidos.Models.PedidoOrdenModelo", "PedidoOrden")
                        .WithMany()
                        .HasForeignKey("PedidoOrdenPedidoId")
                        .OnDelete(DeleteBehavior.Restrict);

                    b.HasOne("ProyectoPedidos.Models.SupervisorModelo", "Supervisor")
                        .WithMany()
                        .HasForeignKey("SupervisorId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.Navigation("PedidoOrden");
